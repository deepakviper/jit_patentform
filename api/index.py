...
# 1. Setup paths relative to the root (one level up from /api)
API_DIR = os.path.abspath(os.path.dirname(__file__))
BASE_DIR = os.path.abspath(os.path.dirname(API_DIR))
backend_path = os.path.join(BASE_DIR, "backend")

# 2. Add backend path to sys.path to dynamically import Flask app and components
